...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('#timer', '2021-09-31');
...
var forms = function forms(state) {
  ...
  var postData = function postData(url, data) {
    var statusLoading, res;
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            statusLoading = document.createElement('img');
            statusLoading.src = message.loading;
            document.querySelector('.status').append(statusLoading);
            _context.next = 5;
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  var tabParent = document.querySelector(headerSelector),
